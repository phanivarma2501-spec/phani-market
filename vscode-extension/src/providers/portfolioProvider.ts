...
export class PortfolioProvider implements vscode.WebviewViewProvider {
    private _view?: vscode.WebviewView;
    constructor(private readonly _ctx: vscode.ExtensionContext, private readonly _bot: BotManager) {}
...
export class ReasoningProvider implements vscode.WebviewViewProvider {
    private _view?: vscode.WebviewView;
    constructor(private readonly _ctx: vscode.ExtensionContext, private readonly _bot: BotManager) {}
    resolveWebviewView(view: vscode.WebviewView) {
        this._view = view;
...
export class MarketsProvider implements vscode.WebviewViewProvider {
    ...
    private _render() {
        ...
        const domainColors: Record<string,string> = { crypto:'#fbbf24', politics:'#a78bfa', economics:'#34d399' };
