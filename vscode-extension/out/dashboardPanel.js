...
class DashboardPanel {
    static createOrShow(extensionUri, botManager) {
        ...
        const panel = vscode.window.createWebviewPanel('polymarketDashboard', 'Polymarket Bot Dashboard', column || vscode.ViewColumn.One, {
            enableScripts: true,
            retainContextWhenHidden: true,
        });
        DashboardPanel.currentPanel = new DashboardPanel(panel, extensionUri, botManager);
    }
    constructor(panel, extensionUri, botManager) {
        this._disposables = [];
        this._panel = panel;
